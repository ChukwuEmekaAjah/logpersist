...
function createMessage(message, options){
	console.log("group name is ", options.group);
...
function log(message, options){
	...
	var options = options ? options.group ? options : {group:this.group} : {group:this.group}
	...
	if(options.notification){
		notifications.triggerNotification(message, options.notification)
	}
